...
async function getList() {
    let response = await fetch('/employees_TW/List');
...
async function editLine(id) {
    ...
    objToServer.start=start;
    objToServer.end=end;
    objToServer.date=date;
    let response = await fetch('/employees_TW/EditStart', {
            method: 'PATCH',
            headers: {
...
async function deleteLine(id) {
    let objToServer={};
    objToServer.id=id;
    let response = await fetch('/employees_TW/Del', {
            method: 'DELETE',
            headers: {
                'Content-Type': 'application/json'
            },
